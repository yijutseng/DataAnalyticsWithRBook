...
```
```{r choroplethr_wdi_1 , warning=F,message=F, fig.height=3}
library(WDI)
...
```{r choroplethr_wdi_2,warning=F,message=F, fig.height=4}
...
```{r choroplethr_wdi_3,eval=F, warning=F,message=F, fig.height=2.5}
...
```{r treemapify1, message=FALSE,warning=F,fig.height=4}
