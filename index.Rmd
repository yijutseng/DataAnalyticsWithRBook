...
pkg<-c('ggplot2', 'dplyr','lubridate','bit64','bookdown','knitr','rmarkdown','RCurl','data.table','stringr','reshape2','SportsAnalytics','readr','readxl','jsonlite','XML','Rfacebook','rvest','rgdal','rgeos','maptools','ggmap','choroplethr','choroplethrMaps','WDI','treemapify')
...
如果您想修改文字或範例，歡迎在GitHub上直接修改，若無GitHub帳號，可透過[此連結]((https://goo.gl/forms/5Htobvwy2vsB7yiF3){target="_blank"})提供建議與回饋。
